...
import { EnvelopeIcon, BookOpenIcon, CalendarIcon, MusicalNoteIcon, HeartIcon, ChatBubbleLeftRightIcon, BookmarkIcon, ClipboardDocumentListIcon, CameraIcon, LockClosedIcon } from "@heroicons/react/24/outline";
    ...
    <div className="min-h-screen flex flex-col pb-20 lg:pb-0" style={glass}>
      ...
      <div className="flex flex-col gap-3 px-4 py-4">
        ...
        <Link
          ...
          style={cardGlass}
        >
          <ChatBubbleLeftRightIcon width={28} height={28} strokeWidth={1.5} style={{ color: brand }} />
          <div className="flex-1">
            <p className="font-semibold text-gray-900">전도 구문집</p>
            <p className="text-gray-500 text-xs mt-0.5">한·몽 표현 모음</p>
          </div>
          <span className="text-xs font-medium px-2.5 py-1 rounded-full" style={{ background: "rgba(22,101,52,0.10)", color: brandDark }}>전도팀</span>
        </Link>
        ...
        <Link
          ...
          style={cardGlass}
        >
          <ClipboardDocumentListIcon width={28} height={28} strokeWidth={1.5} style={{ color: brand }} />
          <div className="flex-1">
            <p className="font-semibold text-gray-900">공연 큐시트</p>
        ...
        <Link
          ...
          style={cardGlass}
        >
          <CameraIcon width={28} height={28} strokeWidth={1.5} style={{ color: brand }} />
          <div className="flex-1">
            <p className="font-semibold text-gray-900">선교 사진</p>
            <p className="text-gray-500 text-xs mt-0.5">몽골 현지 사진 모음</p>
          </div>
          <span
            className="text-xs font-medium px-2.5 py-1 rounded-full flex items-center gap-1"
            style={{ background: "rgba(22, 101, 52, 0.10)", color: brandDark }}
          >
