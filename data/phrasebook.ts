...
export const phrasebookData: PhrasebookSection[] = [
  ...
  },
  {
    ...
    emoji: "💚",
    phrases: [
      { ko: "하나님은 당신을 사랑하십니다", mn: "Бурхан танд хайртай.", pron: "부르항 탄드 해르태" },
      { ko: "하나님의 축복이 있기를 바랍니다", mn: "Бурхан таныг ивээх болтугай.", pron: "부르항 타닉 이웨-흐 볼토개" },
      { ko: "당신을 위해 기도하겠습니다", mn: "Би таны төлөө залбиръя.", pron: "비 타니 털러 잘비리야" },
      { ko: "예수님은 당신의 친구입니다", mn: "Есүс бол таны найз.", pron: "예수쓰 볼 타니 내즈" },
      { ko: "당신은 소중한 사람입니다", mn: "Та бол эрхэм нандин хүн.", pron: "타 볼 에르헴 난딩 훙" },
      { ko: "만나서 정말 기쁩니다", mn: "Уулзсандаа маш их баяртай байна.", pron: "오올쯔싼다 마시 이흐 바야르태 배나" },
    ],
  },
  {
    key: "gospel",
